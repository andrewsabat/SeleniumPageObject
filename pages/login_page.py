...
class LoginPage(BasePage):
    ...
    def register_new_user(self, email, password):
        ...
        password_confirm_input = self.browser.find_element(*LoginPageLocators.REGISTER_PASS_CONFIRM)
        email_input.send_keys(email)
        password_input.send_keys(password)
        password_confirm_input.send_keys(password)
        submit_button = self.browser.find_element(*LoginPageLocators.SUBMIT_REGISTER_BUTTON)
        submit_button.click()
